...
export const en: LandingDict = {
  ...
  programs: {
    ...
    pullup_pitch: "From no hang to a rep you own.",
    muscleup_pitch: "The transition is the bottleneck.",
    engine_block2_pitch: "Block 1 done? This is the sharp end.",
    roadmap_link: "See what's in build — the roadmap →",
  ...
  evidence: {
    ...
    title: "124 primary studies. Every session cites its research.",
    read_link: "Read",
  },
  wontdo: {
