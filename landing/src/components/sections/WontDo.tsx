...
export function WontDo({ dict }: { dict: LandingDict }) {
  const t = dict.wontdo;
  return (
    <section className="relative mx-auto max-w-3xl px-5 py-8 sm:px-6 sm:py-12">
      <details className="group rounded-2xl border border-white/[0.06] bg-white/[0.02] px-5 py-4 open:pb-5">
